...
namespace BuzzFeed2
{
	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			SqlConnection connection = new SqlConnection(@"Data Source=10.1.10.148;Initial Catalog=Buzzfeed-Session3;Persist Security Info=True;User ID=session3;Password=12345;"); connection.Open();
